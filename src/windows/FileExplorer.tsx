...
export function FileExplorer({ windowId }: props) {
    ...
    const { createFileExplorerWindow, createBraveBrowserWindow } =
            ...
            >
                <div className="min-h-14 bg-zinc-800 w-full h-fit p-2 flex justify-start items-center gap-5">
                    <div className="flex justify-center items-center gap-9">
                        <ArrowLeft
                            size={28}
                            className="text-slate-400 hover:bg-slate-200/30 rounded-lg duration-150"
                        />
                    ...
                    <div className="h-full w-1/2 bg-zinc-700/50 flex justify-start items-center flex-shrink-0 gap-4 pl-3">
                        ...
                        <p className="text-slate-50">{currentPath}</p>
                    </div>
                    <div className="h-full w-full bg-zinc-700/50 flex justify-start items-center gap-4 pl-3">
                        <input
                            className="w-full bg-slate-950/0 outline-none text-slate-50"
                            type="text"
                ...
                <div
                    ...
                    className="bg-stone-900 border-t-[0.5px] border-t-slate-600 flex justify-start items-stretch"
                >
                    <div className="border-r-[0.5px] border-r-slate-600 w-[250px] overflow-y-auto flex flex-col gap-3 p-1 pt-5 pb-5">
                        ...
                        <div
                            className={`pl-8 p-2 rounded-l flex justify-start items-center gap-3 bg-slate-500/40 cursor-pointer ${
                                currentPath === "Desktop"
                                    ? "bg-slate-500/40"
                                    : "hover:bg-slate-500/40 bg-transparent"
                            }`}
                        ...
                        <div
                            className={`pl-8 p-2 flex justify-start items-center gap-3 bg-slate-500/40 cursor-pointer ${
                        ...
                        <div
                            className="pl-8 p-2 flex justify-start items-center gap-3 hover:bg-slate-500/40 rounded duration-150 cursor-pointer"
                    ...
                    {currentPath === "Desktop" && (
                        <div className="w-full h-full p-4 flex flex-col flex-1">
                            <div
                                className="flex items-center h-fit w-full gap-10 pl-5 hover:bg-slate-500/40 duration-150 cursor-pointer p-3 rounded-sm"
                                onDoubleClick={createFileExplorerWindow}
                            >
                                ...
                                <p className="text-slate-300">Shortcut</p>
                            </div>
                            <div
                                className="flex items-center h-fit w-full gap-10 pl-5 hover:bg-slate-500/40 duration-150 cursor-pointer p-3 rounded-sm"
                                onDoubleClick={createBraveBrowserWindow}
                            >
                                <div className="flex items-center justify-start gap-2 w-full">
                                    <img
