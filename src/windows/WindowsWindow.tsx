import BraveIcon from "@/assets/icons/brave-browser.png";
        ...
        <div className="w-full h-full">
            ...
            >
                ...
                <div className="w-full h-[100px] bg-slate-900/40 rounded-b-xl flex items-center pl-12 pr-12">
                    ...
                    <button
                        className="hover:bg-slate-500/50 p-2 rounded duration-100"
            ...
            <div
                className="w-full h-full z-[49] absolute top-0 left-0"
                onClick={close}
            />
        </div>,
